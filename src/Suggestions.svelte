...
<section class="suggestions">
    {#if filteredSuggestions.length}
        ...
        {/each}
    {:else}
        <article class="suggestions__empty">
            <div class="suggestions__empty-container">
                <svg
                    class="suggestions__empty-img"
                    width="102"
                    height="108"
                    ...
                    ></svg
                >
                <div class="suggestions__empty--text">
                    <h3 class="suggestions__empty--title">
                        There is no feedback yet.
                    </h3>
                    <p class="suggestions__empty--para">
                        Got a suggestion? Found a bug that needs to be squashed?
                        We love hearing about new ideas to improve our app.
                    </p>
                </div>
                <button
                    class="suggestions__btn btn btn--violet btn--padded"
                    on:click={() => {
